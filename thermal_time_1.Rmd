...
temps$week.no <- 1 + difftime(temps$week.begin, week.START, units = "weeks") #of weeks since origin. Instead of a column in a dataframe, it could potentially be part of a formula.
