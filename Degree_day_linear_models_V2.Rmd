...
##lsurf lmer
mod3.lsurf <- lmer(data = DDSUMS.lsurf, formula = degree.days ~ Veg + totalO_thk + Veg * totalO_thk + (1|site))
summary(mod3.lsurf)

##lsurf lm
mod4.lsurf <- lm(data = DDSUMS.lsurf, formula = degree.days ~ Veg + totalO_thk + Veg * totalO_thk)
summary(mod4.lsurf)
plot(mod4.lsurf)
...
##m0surf lmer
mod3.m0surf <- lmer(data = DDSUMS.m0surf, formula = degree.days ~ Veg + totalO_thk + Veg * totalO_thk + (1|site))
summary(mod3.m0surf)

##m0surf lm
mod4.m0surf <- lm(data = DDSUMS.m0surf, formula = degree.days ~ Veg + totalO_thk + Veg * totalO_thk)
summary(mod4.m0surf)
plot(mod4.m0surf)
...
##m10 lmer
mod3.m10 <- lmer(data = DDSUMS.m10, formula = degree.days ~ Veg + totalO_thk + Veg * totalO_thk + (1|site))
summary(mod3.m10)

##m10 lm
mod4.m10 <- lm(data = DDSUMS.m10, formula = degree.days ~ Veg + totalO_thk + Veg * totalO_thk)
summary(mod4.m10)
...
##m30 lmer
mod3.m30 <- lmer(data = DDSUMS.m30, formula = degree.days ~ Veg + totalO_thk + Veg * totalO_thk + (1|site))
summary(mod3.m30)

##m30 lm
mod4.m30 <- lm(data = DDSUMS.m30, formula = degree.days ~ Veg + totalO_thk + Veg * totalO_thk)
summary(mod4.m30)
...
summary(mod4.lsurf)
plot(mod4.lsurf)
plot(residuals(mod4.lsurf) ∼ fitted.values(mod4.lsurf))
...
summary(mod4.m0surf)
plot(mod4.m0surf)
plot(residuals(mod4.m0surf) ∼ fitted.values(mod4.m0surf))
...
summary(mod4.m10)
plot(residuals(mod4.m10) ∼ fitted.values(mod4.m10))
...
summary(mod4.m30)
plot(residuals(mod4.m30) ∼ fitted.values(mod4.m30))
