...
Files needed: 
ALL_A.csv - all iButton data in one file, long form 

sensor_list.csv - list of iButton sensor names (site, rep, position)

2YR_replicate_PIT_depths_OA.csv - depths of O and A horizons at all soil pits and for each year.
...
#### Remove all values less than or equal to 0 (base temp)
...
#Selects data that is greater than time.start AND less than time.end, creates new dataframe
